...
__Jira/Mantis__
  ...
  * Experimentada en la configuración de proyectos, organización de tareas y monitoreo del progreso. Ejemplo de reportes de defecto en un tablero de Jira [ aquí](https://tokaisushi.atlassian.net/jira/software/projects/YSI/boards/3)
